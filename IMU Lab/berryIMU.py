...
while True:
    ...
    # print(outputString + str(count)) # <- DELTA


    # Write to the text file
    gesture_accx = ACCx * conversion_constant * 9.81 / 1000
    gesture_accy = ACCy * conversion_constant * 9.81 / 1000
    gesture_accz = ACCz * conversion_constant * 9.81 / 1000
...
# Preliminary stopgap while sklearn cannot be downloaded yet on Pi
# Calculate this formula gyr_power = np.sum(gX**2 + gZ**2)
